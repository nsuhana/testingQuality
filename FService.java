	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == b) {
			...
			for (int i = 0; i < 5; i++) {
				...
				q = "UPDATE servcost SET price=" + Double.parseDouble(jtf[i].getText().toString()) + " WHERE serv='"
						+ jl[i].getText().toString().charAt(0) + "'";
				if (!obj.updateq(q)) {
			...
			if (f == 1)
				JOptionPane.showMessageDialog(null, "Data Succesfully Updated!", "Success :)",
